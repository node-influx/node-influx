 ...
 * @type {Array}
 */
const resubmitErrorCodes = ['ETIMEDOUT', 'ESOCKETTIMEDOUT', 'ECONNRESET', 'ECONNREFUSED', 'EHOSTUNREACH'];
...
export class RequestError extends Error {
  ...
  public static Create(req: http.ClientRequest, res: http.IncomingMessage, callback: (e: RequestError) => void): void {
    let body = '';
    res.on('data', str => {
      body += str.toString();
    });
...
const request = (options: http.RequestOptions, callback: (res: http.IncomingMessage) => void): http.ClientRequest => {
...
export class Pool {
   ...
   */
  public stream(options: IPoolRequestOptions, callback: (err: Error, res: http.IncomingMessage) => void): void {
